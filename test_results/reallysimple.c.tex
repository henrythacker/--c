...
The expected result for this test is Result: 24
\subsection{Interpreter Result}
The result from the interpreter is 24
\subsection{Generated TAC}
\begin{verbatim}
Environment: 0x100101220
Static link via: 0x100100570 [Nested 1 levels deep]
[97]:
	int - identifier: a, value: 23 - var_number: 0
[642]:

...
\begin{description}
	...
	\item[MIPS] In this example there is a lot of overhead introduced by creating the complex activation record. For simple ``leaf functions" like \verb!_main!, the activation record could be avoided altogether. Despite the complexity, the code produces the correct answer.
\end{description}
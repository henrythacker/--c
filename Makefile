...
OBJS = lex.yy.o C.tab.o symbol_table.o nodes.o main.o interpreter.o environment.o conversion.o output.o arithmetic.o tacgenerator.o utilities.o mips.o codegen_utils.o registers.o
SRCS = lex.yy.c C.tab.c symbol_table.c nodes.c main.c interpreter.c environment.c conversion.c output.c arithmetic.c tacgenerator.c utilities.c mips.c codegen_utils.c registers.c

...
\begin{description}
	...
	\item[TT\_ASSIGN] is written as: \\ \ \verb![correct_string_rep(quad->result)] [correct_string_rep(quad->op)] [correct_string_rep(quad->operand1)]!, e.g: \verb!_t2 = 5!
	\item[TT\_GOTO] is written as: \\ \ \verb!Goto [correct_string_rep(quad->operand1)]!, e.g: \verb!Goto __if4end!
	\item[TT\_OP] is written as: \\ \ \verb![correct_string_rep(quad->result)] = [correct_string_rep(quad->operand1)] [correct_string_rep(quad->op)] [correct_string_rep(quad->operand2)]!, e.g: \verb!_t4 = 5 + _t1!
